...
class GlassContent extends StatelessWidget{
  const GlassContent({required Key key, required this.size,}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Anurag \nKewat", style: TextStyle(fontSize: 100, fontWeight: FontWeight.bold, color: Colors.white, height: 1.5),),
